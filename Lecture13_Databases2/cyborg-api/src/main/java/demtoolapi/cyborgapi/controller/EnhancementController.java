...
public class EnhancementController {
    ...
    @GetMapping(params = "cyborgId")
    public List<Enhancement> getEnhancementsByCyborgId(@RequestParam Long cyborgId) {
        return repository.getEnhancementsByCyborgId(cyborgId);
    }
